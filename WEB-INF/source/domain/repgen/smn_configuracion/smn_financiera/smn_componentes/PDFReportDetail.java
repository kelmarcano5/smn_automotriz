...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("cmp_unidad_servicio");
			if (d != null)
			{
			name  = "b_service_unit";
		...
		d = rs.getString("cmp_vigencia_hasta");
			if (d != null)
			{
		...
		d = rs.getString("cmp_unidad_servicio_name");
			if (d != null)
			{
			name  = "b_service_unit";
			label = "${lbl:b_service_unit}";
		...
		d = rs.getString("cmp_area_servicio_name");
			if (d != null)
			{
			name  = "b_service_area";
		...
		d = rs.getString("cmp_vigencia_desde");
			if (d != null)
			{
		...
		d = rs.getString("cmp_trans_general_name");
			if (d != null)
			{
		...
		d = rs.getString("cmp_trans_general");
			if (d != null)
			{
			name  = "b_general_transaction";
			label = "${lbl:b_general_transaction}";
		...
		d = rs.getString("cmp_area_servicio");
			if (d != null)
			{
			name  = "b_service_area";
			label = "${lbl:b_service_area}";
