...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("svc_tipo_servicio");
			if (d != null)
			{
			name  = "b_service_type";
		...
		d = rs.getString("svc_tipo_servicio_name");
			if (d != null)
			{
			name  = "b_service_type";
			label = "${lbl:b_service_type}";
		...
		d = rs.getString("svc_area_servicio_name");
			if (d != null)
			{
			name  = "b_service_area";
		...
		d = rs.getString("svc_clase_auxiliar");
			if (d != null)
			{
		...
		d = rs.getString("svc_clase_auxiliar_name");
			if (d != null)
			{
			name  = "b_auxiliary_class";
			label = "${lbl:b_auxiliary_class}";
		...
		d = rs.getString("svc_unidad_servicio");
			if (d != null)
			{
			name  = "b_service_unit";
		...
		d = rs.getString("svc_unidad_servicio_name");
			if (d != null)
			{
			name  = "b_service_unit";
			label = "${lbl:b_service_unit}";
		...
		d = rs.getString("svc_area_servicio");
			if (d != null)
			{
			name  = "b_service_area";
			label = "${lbl:b_service_area}";
