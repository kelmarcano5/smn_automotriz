CREATE TABLE smn_automotriz.smn_afiliado_titular(
...
CREATE SEQUENCE smn_automotriz.seq_smn_afiliado_titular;


CREATE TABLE smn_automotriz.smn_afiliados(
  smn_afiliados_id INTEGER NOT NULL,
  smn_documento_id INTEGER NOT NULL,
  afi_num_control INTEGER NOT NULL,
  smn_contratante_id INTEGER NOT NULL,
  smn_auxiliar_unidades_negocios_rf INTEGER,
  smn_auxiliar_sucursales_rf INTEGER,
  smn_auxiliar_areas_servicios_rf INTEGER,
  ...
  afi_fecha_registro DATE NOT NULL,
  afi_hora CHARACTER(8) NOT NULL,
  afi_nombres CHARACTER(48),
  afi_apellidos CHARACTER(64)
);

CREATE SEQUENCE smn_automotriz.seq_smn_afiliados;


CREATE TABLE smn_automotriz.smn_planes(
...
CREATE SEQUENCE smn_automotriz.seq_smn_planes;


CREATE TABLE smn_automotriz.smn_afiliados_planes(
  smn_afiliados_planes_id INTEGER NOT NULL,
  smn_afiliados_id INTEGER,
  smn_planes_id INTEGER
);

CREATE SEQUENCE smn_automotriz.seq_smn_afiliados_planes;


CREATE TABLE smn_automotriz.smn_agenda(
...
CREATE SEQUENCE smn_automotriz.seq_smn_agenda;


CREATE TABLE smn_automotriz.smn_balance_capacidad(
...
CREATE SEQUENCE smn_automotriz.seq_smn_balance_capacidad;


CREATE TABLE smn_automotriz.smn_balance_citas_agenda(
...
CREATE SEQUENCE smn_automotriz.seq_smn_balance_citas_agenda;


CREATE TABLE smn_automotriz.smn_balance_citas_contratante(
...
CREATE SEQUENCE smn_automotriz.seq_smn_balance_citas_contratante;


CREATE TABLE smn_automotriz.smn_series(
...
CREATE SEQUENCE smn_automotriz.seq_smn_series;


CREATE TABLE smn_automotriz.smn_campos_visualizacion_monitores_dispositivos(
...
CREATE SEQUENCE smn_automotriz.seq_smn_campos_visualizacion_monitores_dispositivos;


CREATE TABLE smn_automotriz.smn_capacidades_unidad(
...
CREATE SEQUENCE smn_automotriz.seq_smn_capacidades_unidad;


CREATE TABLE smn_automotriz.smn_citas(
  smn_citas_id INTEGER NOT NULL,
  smn_documento_id INTEGER NOT NULL,
...
CREATE SEQUENCE smn_automotriz.seq_smn_citas;


CREATE TABLE smn_automotriz.smn_citas_mov(
...
CREATE SEQUENCE smn_automotriz.seq_smn_citas_mov;


CREATE TABLE smn_automotriz.smn_citas_servicios(
  smn_citas_servicios_id INTEGER NOT NULL,
  smn_citas_id INTEGER NOT NULL,
  smn_servicios_id INTEGER NOT NULL
);

CREATE SEQUENCE smn_automotriz.seq_smn_citas_servicios;


CREATE TABLE smn_automotriz.smn_coberturas(
...
CREATE SEQUENCE smn_automotriz.seq_smn_coberturas;


CREATE TABLE smn_automotriz.smn_unidades_servicios(
...
CREATE SEQUENCE smn_automotriz.seq_smn_unidades_servicios;


CREATE TABLE smn_automotriz.smn_coberturas_servicios(
  smn_coberturas_servicios_id INTEGER NOT NULL,
  smn_coberturas_id INTEGER NOT NULL,
  smn_unidades_servicios_id INTEGER NOT NULL
);

CREATE SEQUENCE smn_automotriz.seq_smn_coberturas_servicios;


CREATE TABLE smn_automotriz.smn_contratante(
  smn_contratante_id INTEGER NOT NULL,
  smn_documento_id INTEGER NOT NULL,
...
CREATE SEQUENCE smn_automotriz.seq_smn_contratante;


CREATE TABLE smn_automotriz.smn_contrato_modulo(
...
CREATE SEQUENCE smn_automotriz.seq_smn_contrato_modulo;


CREATE TABLE smn_automotriz.smn_diagnostico(
...
CREATE SEQUENCE smn_automotriz.seq_smn_diagnostico;


CREATE TABLE smn_automotriz.smn_dispositivos(
  smn_dispositivos_id INTEGER NOT NULL,
...
CREATE SEQUENCE smn_automotriz.seq_smn_dispositivos;


CREATE TABLE smn_automotriz.smn_documento(
  smn_documento_id INTEGER NOT NULL,
...
CREATE SEQUENCE smn_automotriz.seq_smn_documento;


CREATE TABLE smn_automotriz.smn_tipo_documento_afiliado(
...
CREATE SEQUENCE smn_automotriz.seq_smn_tipo_documento_afiliado;


CREATE TABLE smn_automotriz.smn_documento_afiliados(
...
CREATE SEQUENCE smn_automotriz.seq_smn_documento_afiliados;


CREATE TABLE smn_automotriz.smn_estado_presupuesto(
...
CREATE SEQUENCE smn_automotriz.seq_smn_estado_presupuesto;


CREATE TABLE smn_automotriz.smn_estatus_citas(
  smn_estatus_citas_id INTEGER NOT NULL,
...
CREATE SEQUENCE smn_automotriz.seq_smn_estatus_citas;


CREATE TABLE smn_automotriz.smn_fallas(
  smn_sintoma_id INTEGER NOT NULL,
...
CREATE SEQUENCE smn_automotriz.seq_smn_fallas;


CREATE TABLE smn_automotriz.smn_horario(
...
CREATE SEQUENCE smn_automotriz.seq_smn_horario;


CREATE TABLE smn_automotriz.smn_ingreso_cola_virtual(
...
CREATE SEQUENCE smn_automotriz.seq_smn_ingreso_cola_virtual;


CREATE TABLE smn_automotriz.smn_ingreso_movimiento(
...
CREATE SEQUENCE smn_automotriz.seq_smn_ingreso_movimiento;


CREATE TABLE smn_automotriz.smn_ingresos(
...
CREATE SEQUENCE smn_automotriz.seq_smn_ingresos;


CREATE TABLE smn_automotriz.smn_ingresos_mov(
  smn_ingresos_mov_id INTEGER NOT NULL,
...
CREATE SEQUENCE smn_automotriz.seq_smn_ingresos_mov;


CREATE TABLE smn_automotriz.smn_ingresos_servicios(
  smn_ingresos_servicios_id INTEGER NOT NULL,
  smn_ingresos_id INTEGER NOT NULL,
  smn_v_servicios_id INTEGER NOT NULL
);

CREATE SEQUENCE smn_automotriz.seq_smn_ingresos_servicios;


CREATE TABLE smn_automotriz.smn_localidad(
...
CREATE SEQUENCE smn_automotriz.seq_smn_localidad;


CREATE TABLE smn_automotriz.smn_sector(
...
CREATE SEQUENCE smn_automotriz.seq_smn_sector;


CREATE TABLE smn_automotriz.smn_localidad_sector(
  smn_rel_local_sector_id INTEGER NOT NULL,
  smn_localidad_id INTEGER,
  smn_sector_id INTEGER
);

CREATE SEQUENCE smn_automotriz.seq_smn_localidad_sector;


CREATE TABLE smn_automotriz.smn_motivos(
...
CREATE SEQUENCE smn_automotriz.seq_smn_motivos;


CREATE TABLE smn_automotriz.smn_no_registrados(
...
CREATE SEQUENCE smn_automotriz.seq_smn_no_registrados;


CREATE TABLE smn_automotriz.smn_observaciones(
...
CREATE SEQUENCE smn_automotriz.seq_smn_observaciones;


CREATE TABLE smn_automotriz.smn_ordenes_mecanicas(
...
CREATE SEQUENCE smn_automotriz.seq_smn_ordenes_mecanicas;


CREATE TABLE smn_automotriz.smn_ordenes_medicas(
  smn_ordenes_medicas_id INTEGER NOT NULL,
  omd_numero_orden VARCHAR(16) NOT NULL,
  omd_descripcion VARCHAR(256) NOT NULL,
  omd_clase_auxiliar INTEGER,
...
CREATE SEQUENCE smn_automotriz.seq_smn_ordenes_medicas;


CREATE TABLE smn_automotriz.smn_origen(
  smn_origen_id INTEGER NOT NULL,
...
CREATE SEQUENCE smn_automotriz.seq_smn_origen;


CREATE TABLE smn_automotriz.smn_planes_coberturas(
  smn_planes_coberturas_id INTEGER NOT NULL,
  smn_planes_id INTEGER NOT NULL,
  smn_coberturas_id INTEGER NOT NULL
);

CREATE SEQUENCE smn_automotriz.seq_smn_planes_coberturas;


CREATE TABLE smn_automotriz.smn_planificacion_de_turno(
...
CREATE SEQUENCE smn_automotriz.seq_smn_planificacion_de_turno;


CREATE TABLE smn_automotriz.smn_prestacion_servicio_mecanico_cabecera(
  smn_prestacion_servicio_mecanico_cabecera_id INTEGER NOT NULL,
  smn_ingresos_id INTEGER NOT NULL,
...
CREATE SEQUENCE smn_automotriz.seq_smn_prestacion_servicio_mecanico_cabecera;


CREATE TABLE smn_automotriz.smn_prestacion_servicio_mecanico_detalle(
  smn_prestacion_servicio_mecanico_detalle_id INTEGER NOT NULL,
  smn_prestacion_servicio_mecanico_cabecera_id INTEGER NOT NULL,
...
CREATE SEQUENCE smn_automotriz.seq_smn_prestacion_servicio_mecanico_detalle;


CREATE TABLE smn_automotriz.smn_prestacion_servicio_medico_cabecera(
...
CREATE SEQUENCE smn_automotriz.seq_smn_prestacion_servicio_medico_cabecera;


CREATE TABLE smn_automotriz.smn_prestacion_servicio_medico_detalle(
...
CREATE SEQUENCE smn_automotriz.seq_smn_prestacion_servicio_medico_detalle;


CREATE TABLE smn_automotriz.smn_presupuesto(
...
CREATE SEQUENCE smn_automotriz.seq_smn_presupuesto;


CREATE TABLE smn_automotriz.smn_presupuesto_detalle(
...
CREATE SEQUENCE smn_automotriz.seq_smn_presupuesto_detalle;


CREATE TABLE smn_automotriz.smn_rel_cobertura_horario(
  smn_rel_cobertura_horario_id INTEGER NOT NULL,
  smn_coberturas_id INTEGER NOT NULL,
  smn_horarios_id INTEGER NOT NULL
);

CREATE SEQUENCE smn_automotriz.seq_smn_rel_cobertura_horario;


CREATE TABLE smn_automotriz.smn_rel_cobertura_localidad(
  smn_rel_cobertura_local_id INTEGER NOT NULL,
  smn_coberturas_id INTEGER NOT NULL,
  smn_localidad_id INTEGER NOT NULL
);

CREATE SEQUENCE smn_automotriz.seq_smn_rel_cobertura_localidad;


CREATE TABLE smn_automotriz.smn_rel_ingreso_mov_examenes(
  smn_rel_ingreso_mov_examenes_id INTEGER NOT NULL,
  smn_ingresos_mov_id INTEGER NOT NULL,
  smn_servicios_id INTEGER NOT NULL
);

CREATE SEQUENCE smn_automotriz.seq_smn_rel_ingreso_mov_examenes;


CREATE TABLE smn_automotriz.smn_rel_plan_contrato(
...
CREATE SEQUENCE smn_automotriz.seq_smn_rel_plan_contrato;


CREATE TABLE smn_automotriz.smn_rel_usuarios_entidad(
...
CREATE SEQUENCE smn_automotriz.seq_smn_rel_usuarios_entidad;


CREATE TABLE smn_automotriz.smn_relacion_area_series(
  smn_rel_area_serie_id INTEGER NOT NULL,
  smn_series_id INTEGER NOT NULL,
  smn_areas_servicios_id INTEGER NOT NULL
);

CREATE SEQUENCE smn_automotriz.seq_smn_relacion_area_series;


CREATE TABLE smn_automotriz.smn_tramos(
...
CREATE SEQUENCE smn_automotriz.seq_smn_tramos;


CREATE TABLE smn_automotriz.smn_relacion_horario_tramos(
  smn_rel_horario_tramo_id INTEGER NOT NULL,
  smn_horarios_id INTEGER NOT NULL,
  smn_tramos_id INTEGER NOT NULL
);

CREATE SEQUENCE smn_automotriz.seq_smn_relacion_horario_tramos;


CREATE TABLE smn_automotriz.smn_relacion_unidad_paso(
...
CREATE SEQUENCE smn_automotriz.seq_smn_relacion_unidad_paso;


CREATE TABLE smn_automotriz.smn_relacion_unidades_series(
  smn_relacion_unidades_series_id INTEGER NOT NULL,
  smn_series_id INTEGER NOT NULL,
  smn_unidades_servicios_id INTEGER NOT NULL
);

CREATE SEQUENCE smn_automotriz.seq_smn_relacion_unidades_series;


CREATE TABLE smn_automotriz.smn_relacion_vehiculo_secuencia(
...
CREATE SEQUENCE smn_automotriz.seq_smn_relacion_vehiculo_secuencia;


CREATE TABLE smn_automotriz.smn_relacionados(
...
CREATE SEQUENCE smn_automotriz.seq_smn_relacionados;


CREATE TABLE smn_automotriz.smn_rol(
  smn_rol_id INTEGER NOT NULL,
  smn_usuario_id INTEGER NOT NULL,
...
CREATE SEQUENCE smn_automotriz.seq_smn_rol;


CREATE TABLE smn_automotriz.smn_ruta_paciente(
  smn_ruta_id INTEGER NOT NULL,
  smn_clase_auxiliar_rf INTEGER NOT NULL,
  smn_auxiliar_rf INTEGER,
...
CREATE SEQUENCE smn_automotriz.seq_smn_ruta_paciente;


CREATE TABLE smn_automotriz.smn_ruta_vehiculo(
  smn_ruta_id INTEGER NOT NULL,
  smn_clase_auxiliar_rf INTEGER NOT NULL,
  smn_auxiliar_rf INTEGER,
  rta_numero_documento_identidad CHARACTER(20) NOT NULL,
...
CREATE SEQUENCE smn_automotriz.seq_smn_ruta_vehiculo;


CREATE TABLE smn_automotriz.smn_sintoma(
  smn_sintoma_id INTEGER NOT NULL,
  stm_codigo VARCHAR(16) NOT NULL,
  stm_descripcion VARCHAR(56) NOT NULL,
  stm_idioma CHARACTER(2) NOT NULL,
...
CREATE SEQUENCE smn_automotriz.seq_smn_sintoma;


CREATE TABLE smn_automotriz.smn_tipo_coberturas(
...
CREATE SEQUENCE smn_automotriz.seq_smn_tipo_coberturas;


CREATE TABLE smn_automotriz.smn_tipo_consulta(
...
CREATE SEQUENCE smn_automotriz.seq_smn_tipo_consulta;


CREATE TABLE smn_automotriz.smn_tipo_documento(
  smn_tipo_documento_id INTEGER NOT NULL,
...
CREATE SEQUENCE smn_automotriz.seq_smn_tipo_documento;


CREATE TABLE smn_automotriz.smn_tramos_descanso(
...
CREATE SEQUENCE smn_automotriz.seq_smn_tramos_descanso;


CREATE TABLE smn_automotriz.smn_estatus(
  smn_estatus_id INTEGER NOT NULL,
  sta_codigo CHARACTER(64) NOT NULL,
  sta_descripcion VARCHAR(100) NOT NULL,
  sta_cod_siguiente CHARACTER(2) NOT NULL,
...
CREATE SEQUENCE smn_automotriz.seq_smn_estatus;



ALTER TABLE smn_automotriz.smn_afiliado_titular ADD PRIMARY KEY (smn_afiliados_id);

ALTER TABLE smn_automotriz.smn_afiliados ADD PRIMARY KEY (smn_afiliados_id);

ALTER TABLE smn_automotriz.smn_planes ADD PRIMARY KEY (smn_planes_id);

ALTER TABLE smn_automotriz.smn_afiliados_planes ADD PRIMARY KEY (smn_afiliados_planes_id);
ALTER TABLE smn_automotriz.smn_afiliados_planes ADD CONSTRAINT FK_smn_afiliados_planes_0 FOREIGN KEY (smn_planes_id) REFERENCES smn_automotriz.smn_planes (smn_planes_id) ON DELETE NO ACTION;

ALTER TABLE smn_automotriz.smn_agenda ADD PRIMARY KEY (smn_agenda_id);

ALTER TABLE smn_automotriz.smn_balance_capacidad ADD PRIMARY KEY (smn_balance_capacidad_id);

ALTER TABLE smn_automotriz.smn_balance_citas_agenda ADD PRIMARY KEY (smn_balance_citas_agenda_id);

ALTER TABLE smn_automotriz.smn_balance_citas_contratante ADD PRIMARY KEY (smn_balance_citas_contratante_id);

ALTER TABLE smn_automotriz.smn_series ADD PRIMARY KEY (smn_series_id);

ALTER TABLE smn_automotriz.smn_campos_visualizacion_monitores_dispositivos ADD PRIMARY KEY (smn_campos_vis_mon_dis_id);
ALTER TABLE smn_automotriz.smn_campos_visualizacion_monitores_dispositivos ADD CONSTRAINT FK_smn_campos_visualizacion_monitores_dispositivos_0 FOREIGN KEY (smn_series_id) REFERENCES smn_automotriz.smn_series (smn_series_id) ON DELETE NO ACTION;

ALTER TABLE smn_automotriz.smn_capacidades_unidad ADD PRIMARY KEY (smn_capacidades_id);

ALTER TABLE smn_automotriz.smn_citas ADD PRIMARY KEY (smn_citas_id);

ALTER TABLE smn_automotriz.smn_citas_mov ADD PRIMARY KEY (smn_citas_mov_id);

ALTER TABLE smn_automotriz.smn_citas_servicios ADD PRIMARY KEY (smn_citas_servicios_id);

ALTER TABLE smn_automotriz.smn_coberturas ADD PRIMARY KEY (smn_coberturas_id);

ALTER TABLE smn_automotriz.smn_unidades_servicios ADD PRIMARY KEY (smn_unidades_servicios_id);

ALTER TABLE smn_automotriz.smn_coberturas_servicios ADD PRIMARY KEY (smn_coberturas_servicios_id);
ALTER TABLE smn_automotriz.smn_coberturas_servicios ADD CONSTRAINT FK_smn_coberturas_servicios_0 FOREIGN KEY (smn_coberturas_id) REFERENCES smn_automotriz.smn_coberturas (smn_coberturas_id) ON DELETE NO ACTION;
ALTER TABLE smn_automotriz.smn_coberturas_servicios ADD CONSTRAINT FK_smn_coberturas_servicios_1 FOREIGN KEY (smn_unidades_servicios_id) REFERENCES smn_automotriz.smn_unidades_servicios (smn_unidades_servicios_id) ON DELETE NO ACTION;

ALTER TABLE smn_automotriz.smn_contratante ADD PRIMARY KEY (smn_contratante_id);

ALTER TABLE smn_automotriz.smn_contrato_modulo ADD PRIMARY KEY (smn_contrato_modulo_id);

ALTER TABLE smn_automotriz.smn_diagnostico ADD PRIMARY KEY (smn_diagnostico_id);

ALTER TABLE smn_automotriz.smn_dispositivos ADD PRIMARY KEY (smn_dispositivos_id);

ALTER TABLE smn_automotriz.smn_documento ADD PRIMARY KEY (smn_documento_id);

ALTER TABLE smn_automotriz.smn_tipo_documento_afiliado ADD PRIMARY KEY (smn_tipo_documento_afiliado_id);

ALTER TABLE smn_automotriz.smn_documento_afiliados ADD PRIMARY KEY (smn_documento_afiliados_id);
ALTER TABLE smn_automotriz.smn_documento_afiliados ADD CONSTRAINT FK_smn_documento_afiliados_0 FOREIGN KEY (smn_tipo_documento_afiliado_id) REFERENCES smn_automotriz.smn_tipo_documento_afiliado (smn_tipo_documento_afiliado_id) ON DELETE NO ACTION;

ALTER TABLE smn_automotriz.smn_estado_presupuesto ADD PRIMARY KEY (smn_estado_presupuesto_id);

ALTER TABLE smn_automotriz.smn_estatus_citas ADD PRIMARY KEY (smn_estatus_citas_id);

ALTER TABLE smn_automotriz.smn_fallas ADD PRIMARY KEY (smn_sintoma_id);

ALTER TABLE smn_automotriz.smn_horario ADD PRIMARY KEY (smn_horarios_id);

ALTER TABLE smn_automotriz.smn_ingreso_cola_virtual ADD PRIMARY KEY (smn_ingreso_cola_virtual_id);

ALTER TABLE smn_automotriz.smn_ingreso_movimiento ADD PRIMARY KEY (smn_ingresos_mov_id);

ALTER TABLE smn_automotriz.smn_ingresos ADD PRIMARY KEY (smn_ingresos_id);

ALTER TABLE smn_automotriz.smn_ingresos_servicios ADD PRIMARY KEY (smn_ingresos_servicios_id);

ALTER TABLE smn_automotriz.smn_localidad ADD PRIMARY KEY (smn_localidad_id);

ALTER TABLE smn_automotriz.smn_sector ADD PRIMARY KEY (smn_sector_id);

ALTER TABLE smn_automotriz.smn_localidad_sector ADD PRIMARY KEY (smn_rel_local_sector_id);
ALTER TABLE smn_automotriz.smn_localidad_sector ADD CONSTRAINT FK_smn_localidad_sector_0 FOREIGN KEY (smn_sector_id) REFERENCES smn_automotriz.smn_sector (smn_sector_id) ON DELETE NO ACTION;
ALTER TABLE smn_automotriz.smn_localidad_sector ADD CONSTRAINT FK_smn_localidad_sector_1 FOREIGN KEY (smn_localidad_id) REFERENCES smn_automotriz.smn_localidad (smn_localidad_id) ON DELETE NO ACTION;

ALTER TABLE smn_automotriz.smn_motivos ADD PRIMARY KEY (smn_motivos_id);

ALTER TABLE smn_automotriz.smn_no_registrados ADD PRIMARY KEY (smn_no_registrados_id);

ALTER TABLE smn_automotriz.smn_observaciones ADD PRIMARY KEY (smn_observaciones_id);

ALTER TABLE smn_automotriz.smn_ordenes_mecanicas ADD PRIMARY KEY (smn_ordenes_medicas_id);

ALTER TABLE smn_automotriz.smn_ordenes_medicas ADD PRIMARY KEY (smn_ordenes_medicas_id);

ALTER TABLE smn_automotriz.smn_origen ADD PRIMARY KEY (smn_origen_id);

ALTER TABLE smn_automotriz.smn_planes_coberturas ADD PRIMARY KEY (smn_planes_coberturas_id);
ALTER TABLE smn_automotriz.smn_planes_coberturas ADD CONSTRAINT FK_smn_planes_coberturas_0 FOREIGN KEY (smn_coberturas_id) REFERENCES smn_automotriz.smn_coberturas (smn_coberturas_id) ON DELETE NO ACTION;
ALTER TABLE smn_automotriz.smn_planes_coberturas ADD CONSTRAINT FK_smn_planes_coberturas_1 FOREIGN KEY (smn_planes_id) REFERENCES smn_automotriz.smn_planes (smn_planes_id) ON DELETE NO ACTION;

ALTER TABLE smn_automotriz.smn_planificacion_de_turno ADD PRIMARY KEY (smn_plan_turno_id);

ALTER TABLE smn_automotriz.smn_prestacion_servicio_mecanico_cabecera ADD PRIMARY KEY (smn_prestacion_servicio_mecanico_cabecera_id);

ALTER TABLE smn_automotriz.smn_prestacion_servicio_mecanico_detalle ADD PRIMARY KEY (smn_prestacion_servicio_mecanico_detalle_id);

ALTER TABLE smn_automotriz.smn_prestacion_servicio_medico_cabecera ADD PRIMARY KEY (smn_prestacion_servicio_medico_cabecera_id);

ALTER TABLE smn_automotriz.smn_prestacion_servicio_medico_detalle ADD PRIMARY KEY (smn_prestacion_servicio_medico_detalle_id);

ALTER TABLE smn_automotriz.smn_presupuesto ADD PRIMARY KEY (smn_presupuesto_id);

ALTER TABLE smn_automotriz.smn_presupuesto_detalle ADD PRIMARY KEY (smn_presupuesto_detalle_id);

ALTER TABLE smn_automotriz.smn_rel_cobertura_horario ADD PRIMARY KEY (smn_rel_cobertura_horario_id);
ALTER TABLE smn_automotriz.smn_rel_cobertura_horario ADD CONSTRAINT FK_smn_rel_cobertura_horario_0 FOREIGN KEY (smn_horarios_id) REFERENCES smn_automotriz.smn_horario (smn_horarios_id) ON DELETE NO ACTION;
ALTER TABLE smn_automotriz.smn_rel_cobertura_horario ADD CONSTRAINT FK_smn_rel_cobertura_horario_1 FOREIGN KEY (smn_coberturas_id) REFERENCES smn_automotriz.smn_coberturas (smn_coberturas_id) ON DELETE NO ACTION;

ALTER TABLE smn_automotriz.smn_rel_cobertura_localidad ADD PRIMARY KEY (smn_rel_cobertura_local_id);
ALTER TABLE smn_automotriz.smn_rel_cobertura_localidad ADD CONSTRAINT FK_smn_rel_cobertura_localidad_0 FOREIGN KEY (smn_coberturas_id) REFERENCES smn_automotriz.smn_coberturas (smn_coberturas_id) ON DELETE NO ACTION;
ALTER TABLE smn_automotriz.smn_rel_cobertura_localidad ADD CONSTRAINT FK_smn_rel_cobertura_localidad_1 FOREIGN KEY (smn_localidad_id) REFERENCES smn_automotriz.smn_localidad (smn_localidad_id) ON DELETE NO ACTION;

ALTER TABLE smn_automotriz.smn_rel_plan_contrato ADD PRIMARY KEY (smn_rel_plan_contrato_modulo_id);
ALTER TABLE smn_automotriz.smn_rel_plan_contrato ADD CONSTRAINT FK_smn_rel_plan_contrato_0 FOREIGN KEY (smn_planes_id) REFERENCES smn_automotriz.smn_planes (smn_planes_id) ON DELETE NO ACTION;
ALTER TABLE smn_automotriz.smn_rel_plan_contrato ADD CONSTRAINT FK_smn_rel_plan_contrato_1 FOREIGN KEY (smn_contrato_modulo_id) REFERENCES smn_automotriz.smn_contrato_modulo (smn_contrato_modulo_id) ON DELETE NO ACTION;

ALTER TABLE smn_automotriz.smn_rel_usuarios_entidad ADD PRIMARY KEY (smn_rel_usuario_entidad_id);

ALTER TABLE smn_automotriz.smn_relacion_area_series ADD PRIMARY KEY (smn_rel_area_serie_id);
ALTER TABLE smn_automotriz.smn_relacion_area_series ADD CONSTRAINT FK_smn_relacion_area_series_0 FOREIGN KEY (smn_series_id) REFERENCES smn_automotriz.smn_series (smn_series_id) ON DELETE CASCADE;

ALTER TABLE smn_automotriz.smn_tramos ADD PRIMARY KEY (smn_tramos_id);

ALTER TABLE smn_automotriz.smn_relacion_horario_tramos ADD PRIMARY KEY (smn_rel_horario_tramo_id);
ALTER TABLE smn_automotriz.smn_relacion_horario_tramos ADD CONSTRAINT FK_smn_relacion_horario_tramos_0 FOREIGN KEY (smn_tramos_id) REFERENCES smn_automotriz.smn_tramos (smn_tramos_id) ON DELETE NO ACTION;
ALTER TABLE smn_automotriz.smn_relacion_horario_tramos ADD CONSTRAINT FK_smn_relacion_horario_tramos_1 FOREIGN KEY (smn_horarios_id) REFERENCES smn_automotriz.smn_horario (smn_horarios_id) ON DELETE NO ACTION;

ALTER TABLE smn_automotriz.smn_relacion_unidad_paso ADD PRIMARY KEY (smn_rel_unidad_paso);

ALTER TABLE smn_automotriz.smn_relacion_unidades_series ADD PRIMARY KEY (smn_relacion_unidades_series_id);

ALTER TABLE smn_automotriz.smn_relacion_vehiculo_secuencia ADD PRIMARY KEY (smn_rel_paciente_secuencia_id);

ALTER TABLE smn_automotriz.smn_relacionados ADD PRIMARY KEY (smn_relacionado_id);

ALTER TABLE smn_automotriz.smn_rol ADD PRIMARY KEY (smn_rol_id);

ALTER TABLE smn_automotriz.smn_ruta_paciente ADD PRIMARY KEY (smn_ruta_id);

ALTER TABLE smn_automotriz.smn_ruta_vehiculo ADD PRIMARY KEY (smn_ruta_id);

ALTER TABLE smn_automotriz.smn_sintoma ADD PRIMARY KEY (smn_sintoma_id);

ALTER TABLE smn_automotriz.smn_tipo_coberturas ADD PRIMARY KEY (smn_tipo_coberturas_id);

ALTER TABLE smn_automotriz.smn_tipo_consulta ADD PRIMARY KEY (smn_tipo_consulta_id);

ALTER TABLE smn_automotriz.smn_tipo_documento ADD PRIMARY KEY (smn_tipo_documento_id);

ALTER TABLE smn_automotriz.smn_tramos_descanso ADD PRIMARY KEY (smn_tramo_descanso_id);

ALTER TABLE smn_automotriz.smn_estatus ADD PRIMARY KEY (smn_estatus_id);
