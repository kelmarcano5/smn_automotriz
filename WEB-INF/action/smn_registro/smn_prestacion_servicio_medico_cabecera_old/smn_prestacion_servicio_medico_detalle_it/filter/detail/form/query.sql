select
	...
	case
	when smn_automotriz.smn_prestacion_servicio_medico_detalle.psd_agregado_usuario='SI' then '${lbl:b_yes}'
	when smn_automotriz.smn_prestacion_servicio_medico_detalle.psd_agregado_usuario='NO' then '${lbl:b_not}'
	end as psd_agregado_usuario_combo,
	smn_automotriz.smn_prestacion_servicio_medico_detalle.smn_mov_caja_detalle_id as smn_mov_caja_detalle_id_combo,
	smn_automotriz.smn_ingreso_movimiento.smn_ingresos_mov_id as inm_localidad_pl1,
		smn_automotriz.smn_prestacion_servicio_medico_detalle.smn_almacen_rf as smn_almacen_rf_combo,
	smn_automotriz.smn_prestacion_servicio_medico_detalle.smn_unidades_servicios_rf as smn_unidades_servicios_rf_combo,
	smn_automotriz.smn_prestacion_servicio_medico_detalle.smn_componentes_rf as smn_componentes_rf_combo,
	smn_automotriz.smn_prestacion_servicio_medico_detalle.smn_item_rf as smn_item_rf_combo,
		smn_automotriz.smn_prestacion_servicio_medico_detalle.smn_prestador_servicio_rf as smn_prestador_servicio_rf_combo,
		smn_automotriz.smn_prestacion_servicio_medico_detalle.smn_servicios_rf as smn_servicios_rf_combo,
		smn_automotriz.smn_prestacion_servicio_medico_detalle.smn_moneda_rf as smn_moneda_rf_combo,
		smn_automotriz.smn_prestacion_servicio_medico_detalle.psd_observaciones_rf as obs_descripcion_combo,
