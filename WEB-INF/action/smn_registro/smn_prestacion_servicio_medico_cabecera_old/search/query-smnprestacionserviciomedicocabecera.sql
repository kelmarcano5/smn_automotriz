...
where
	  ...
	  psc_usuario = ${fld:usuario} and smn_automotriz.smn_prestacion_servicio_medico_cabecera.psc_estatus='PE' order by smn_automotriz.smn_ingresos.igs_ticket DESC
