select
	...
	smn_automotriz.smn_series.sri_codigo as smn_serie_id,
	...
	smn_automotriz.smn_ruta_paciente.rta_estatus as estatus,
...
from
	...
	left outer join smn_automotriz.smn_series on smn_automotriz.smn_series.sri_codigo = smn_automotriz.smn_ruta_paciente.smn_serie_id
...
where
	smn_automotriz.smn_ruta_paciente.smn_area_servicio_rf=${fld:area_prestador} and
	smn_base.smn_clase_auxiliar.cla_codigo='VH'
	--and smn_automotriz.smn_ruta_paciente.smn_serie_id<>'F'

order by smn_automotriz.smn_ruta_paciente.rta_fecha_registro DESC
