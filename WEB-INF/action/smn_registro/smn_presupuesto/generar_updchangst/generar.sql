...
UPDATE smn_automotriz.smn_presupuesto_detalle SET prd_estatus='GE' where smn_automotriz.smn_presupuesto_detalle.smn_presupuesto_id=${fld:id} and smn_automotriz.smn_presupuesto_detalle.prd_estatus='RE';
