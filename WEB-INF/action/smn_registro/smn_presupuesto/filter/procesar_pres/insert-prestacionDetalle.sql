...
(
	...
	(select smn_automotriz.smn_ingreso_movimiento.smn_ingresos_mov_id from smn_automotriz.smn_ingreso_movimiento inner join smn_automotriz.smn_ingresos on smn_automotriz.smn_ingresos.smn_ingresos_id = smn_automotriz.smn_ingreso_movimiento.smn_ingreso_id where smn_automotriz.smn_ingresos.igs_doc_origen=${fld:smn_presupuesto_id}),
