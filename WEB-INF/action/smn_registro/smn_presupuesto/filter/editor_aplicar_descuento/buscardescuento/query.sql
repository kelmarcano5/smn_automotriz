...
WITH rows as (
select smn_automotriz.smn_presupuesto_detalle.smn_presupuesto_detalle_id as idp,
smn_automotriz.smn_presupuesto_detalle.prd_monto_moneda_local as monto_ml,
smn_automotriz.smn_presupuesto_detalle.prd_moneda_alterna as monto_ma,
smn_base.smn_descuentos_retenciones.dyr_porcentaje_descuento as porc_descuento,
smn_base.smn_descuentos_retenciones.dyr_porcentaje_base as porc_base,
...
from rows
where
smn_automotriz.smn_presupuesto_detalle.smn_presupuesto_id = ${fld:id} and smn_automotriz.smn_presupuesto_detalle.smn_presupuesto_detalle_id =rows.idp and smn_automotriz.smn_presupuesto_detalle.smn_tipo_componentes_rf='SE';
