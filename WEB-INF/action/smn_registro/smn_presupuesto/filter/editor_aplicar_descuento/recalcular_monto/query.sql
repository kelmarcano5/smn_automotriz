...
pre_monto_neto_moneda_local=(select smn_automotriz.smn_presupuesto.pre_monto_ml from smn_automotriz.smn_presupuesto where smn_automotriz.smn_presupuesto.smn_presupuesto_id=${fld:id})-rows.total_descuento_cab
from rows
where
