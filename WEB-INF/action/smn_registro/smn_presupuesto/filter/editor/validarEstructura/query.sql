...
--	smn_automotriz.smn_contratante.smn_auxiliar_rf = smn_base.smn_auxiliar_terceros.smn_auxiliar_terceros_id
--where smn_automotriz.smn_contratante.smn_contratante_id = ${fld:id}