select
	...
	smn_automotriz.smn_presupuesto_detalle.prd_monto_neto_ml,
	smn_automotriz.smn_presupuesto_detalle.prd_monto_neto_ma,
	case
...
where 
	smn_automotriz.smn_presupuesto_detalle.smn_presupuesto_id = ${fld:id_pre} 
	and smn_base.smn_componentes.cmp_tipo_componente in('SE', 'IT')
order by 
