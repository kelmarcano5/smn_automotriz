select
	...
	smn_automotriz.smn_presupuesto_detalle.prd_moneda_alterna+smn_automotriz.smn_presupuesto_detalle.prd_monto_incremento_ma as prd_moneda_alterna,
	...
	smn_automotriz.smn_presupuesto_detalle.prd_monto_descuento_ma,
	smn_automotriz.smn_presupuesto_detalle.prd_monto_neto_ma-smn_automotriz.smn_presupuesto_detalle.prd_monto_descuento_ma as prd_monto_neto_ma
from 
...
where 
	smn_automotriz.smn_presupuesto_detalle.smn_presupuesto_id = ${fld:id} and smn_automotriz.smn_presupuesto_detalle.smn_tipo_componentes_rf in('IT','SE') and smn_automotriz.smn_presupuesto_detalle.prd_estatus<>'RZ'
