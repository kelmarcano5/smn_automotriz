select 
    ...
    smn_automotriz.smn_prestacion_servicio_medico_cabecera.smn_prestacion_servicio_medico_cabecera_id as smn_prestacion_servicio_medico_cabecera_id,
    smn_caja.smn_mov_caja_detalle.smn_mov_caja_detalle_id as smn_mov_caja_detalle_id,
    smn_automotriz.smn_ingreso_movimiento.smn_ingresos_mov_id as smn_ingresos_mov_id,
    ...
    smn_automotriz.smn_ingresos.smn_moneda_rf as smn_moneda_rf,
    smn_automotriz.smn_ingreso_movimiento.inm_cantidad as psd_cantidad,
    smn_automotriz.smn_ingreso_movimiento.inm_precio_ml as psd_precio_propuesto_ml,
    smn_automotriz.smn_ingreso_movimiento.inm_cantidad * smn_automotriz.smn_ingreso_movimiento.inm_precio_ml as psd_monto_propuesto_ml,
...
from smn_automotriz.smn_ingresos
    ...
    inner join smn_automotriz.smn_prestacion_servicio_medico_cabecera on 
    smn_automotriz.smn_prestacion_servicio_medico_cabecera.smn_mov_caja_cabecera_id = smn_caja.smn_mov_caja_cabecera.smn_mov_caja_cabecera_id
...
WHERE
    smn_automotriz.smn_ingresos.smn_ingresos_id = ${fld:id_ingreso} and smn_caja.smn_mov_caja_cabecera.smn_estatus_cobro = 'PE' and 
        smn_base.smn_servicios_componentes.smn_servicios_id = smn_automotriz.smn_ingreso_movimiento.smn_servicios_rf