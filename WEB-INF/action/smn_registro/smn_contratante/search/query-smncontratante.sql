...
from
	...
	left outer join smn_automotriz.smn_documento on smn_automotriz.smn_documento.smn_documento_id = smn_automotriz.smn_contratante.smn_documento_id
...
order by 
	smn_automotriz.smn_contratante.smn_contratante_id desc