select smn_automotriz.smn_contratante.smn_contratante_id as id, 
smn_base.smn_auxiliar.aux_codigo || ' - ' || 
smn_base.smn_auxiliar.aux_descripcion as item from 
...
order by smn_automotriz.smn_contratante.cnt_numero_control