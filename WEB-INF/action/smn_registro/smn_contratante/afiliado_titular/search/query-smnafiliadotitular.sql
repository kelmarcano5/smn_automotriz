select
	smn_automotriz.smn_afiliado_titular.smn_afiliados_id,
	smn_automotriz.smn_afiliado_titular.afi_numero_control,
	...
	smn_automotriz.smn_documento.smn_documento_id as documento,
		smn_automotriz.smn_documento.doc_codigo || ' - ' || smn_automotriz.smn_documento.doc_nombre as smn_documento_id,
		smn_automotriz.smn_documento.smn_documento_id as documento_rf,
		...
		smn_automotriz.smn_afiliado_titular.afi_auxiliar_rf as afiliado,
	...
	smn_automotriz.smn_afiliado_titular.afi_fecha_registro
	
from

	smn_automotriz.smn_afiliado_titular
	left outer join smn_automotriz.smn_documento on smn_automotriz.smn_documento.smn_documento_id = smn_automotriz.smn_afiliado_titular.smn_documento_id
	...
	left outer join smn_automotriz.smn_contratante on smn_automotriz.smn_contratante.smn_contratante_id = smn_automotriz.smn_afiliado_titular.smn_contratante_id
	left outer join smn_base.smn_auxiliar_terceros on smn_base.smn_auxiliar_terceros.smn_auxiliar_terceros_id = smn_automotriz.smn_contratante.smn_auxiliar_rf


where
	smn_automotriz.smn_afiliado_titular.smn_contratante_id=${fld:contratante_id}
