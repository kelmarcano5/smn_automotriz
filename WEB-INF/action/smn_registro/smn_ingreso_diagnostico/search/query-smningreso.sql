...
where 
  smn_automotriz.smn_ingresos.smn_ingresos_id is not null and
	  ...
	  smn_automotriz.smn_ruta_paciente.smn_unidad_servicio_rf = ${fld:unidad_prestador} and  smn_automotriz.smn_ruta_paciente.rta_estatus IN ('IN')
	  --  and smn_automotriz.smn_ingresos.igs_usuario='${def:user}' and smn_automotriz.smn_rol.rol_tipo='SO'
order by 
