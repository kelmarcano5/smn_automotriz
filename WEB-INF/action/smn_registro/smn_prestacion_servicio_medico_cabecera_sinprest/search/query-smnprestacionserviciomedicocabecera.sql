select 
	...
	smn_automotriz.smn_prestacion_servicio_medico_cabecera.smn_prestador_servicio_rf,
	smn_automotriz.smn_prestacion_servicio_medico_cabecera.smn_grupo_prestador_rf
from
	...
	left join smn_base.smn_unidades_servicios on smn_base.smn_unidades_servicios.smn_unidades_servicios_id = smn_automotriz.smn_prestacion_servicio_medico_cabecera.smn_unidades_servicios_rf
	left join smn_base.smn_prestadores_servicios on smn_base.smn_prestadores_servicios.smn_prestadores_servicios_id = smn_automotriz.smn_prestacion_servicio_medico_cabecera.smn_prestador_servicio_rf
...
where
	smn_automotriz.smn_prestacion_servicio_medico_cabecera.smn_unidades_servicios_rf = ${fld:unidad_prestador} and smn_automotriz.smn_prestacion_servicio_medico_cabecera.psc_estatus='PE' order by smn_automotriz.smn_ingresos.igs_ticket DESC