select DISTINCT
	...
	case 
		when smn_automotriz.smn_diagnostico_det_estruc_item.smn_item_rf is null then 0 else smn_automotriz.smn_diagnostico_det_estruc_item.smn_item_rf
	end as smn_item_rf,
	case 
...
from 
	...
	left outer join smn_automotriz.smn_diagnostico_cab_auto 
	...
	on smn_base.smn_baremos_detalle.smn_servicios_rf = smn_automotriz.smn_diagnostico_det_estruc_item.smn_servicios_rf
...
where 
	smn_automotriz.smn_diagnostico_cab_auto.smn_ingresos_id = ${fld:id_ingreso} and smn_automotriz.smn_diagnostico_det_estruc_item.smn_tipo_componente='SE'
