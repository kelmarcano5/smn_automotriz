...
where smn_automotriz.smn_rol.smn_area_servicio_rf=${fld:id} and smn_base.smn_unidades_servicios.smn_tipo_unidad_administrativa='DS' and smn_seguridad.s_user.userlogin = '${def:user}' GROUP BY id