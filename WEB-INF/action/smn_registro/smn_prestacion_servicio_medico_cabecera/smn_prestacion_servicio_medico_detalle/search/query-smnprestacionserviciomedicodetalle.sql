select
	...
	smn_automotriz.smn_prestacion_servicio_medico_detalle.psd_monto_propuesto_ml as montoml,
	smn_automotriz.smn_prestacion_servicio_medico_detalle.psd_monto_propuesto_ma as montoma
...
where
	...
	smn_automotriz.smn_prestacion_servicio_medico_detalle.smn_prestacion_servicio_medico_cabecera_id = ${fld:id2}