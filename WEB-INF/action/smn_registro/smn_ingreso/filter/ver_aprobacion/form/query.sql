select
	...
	smn_automotriz.smn_ingresos.smn_unidades_servicios_rf as unidad,
	smn_automotriz.smn_ingresos.igs_ticket as ticket,
	to_char(smn_automotriz.smn_ingresos.igs_fecha_registro, 'YYYY-MM-DD') as fecha,
	...
	(select smn_base.smn_auxiliar.aux_codigo || ' - ' || smn_base.smn_auxiliar.aux_descripcion from smn_base.smn_auxiliar where smn_base.smn_auxiliar.smn_auxiliar_id = smn_automotriz.smn_ingresos.smn_auxiliar_rf) as vehiculo,
	smn_automotriz.smn_ingresos.igs_kilometraje,
	smn_automotriz.smn_ingresos.igs_serial_bateria,	
	smn_automotriz.smn_sintoma.stm_codigo||' - '|| smn_automotriz.smn_sintoma.stm_descripcion as smn_sintoma_id_combo,
...
from 
	...
	left outer join smn_automotriz.smn_sintoma on smn_automotriz.smn_sintoma.smn_sintoma_id = smn_automotriz.smn_ingresos.smn_sintoma_id
where
