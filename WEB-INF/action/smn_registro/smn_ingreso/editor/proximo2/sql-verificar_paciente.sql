...
left outer join smn_automotriz.smn_ingreso_cola_virtual icv on
	rta.rta_numero_documento_identidad = icv.icv_numero_documento_identidad
left outer join smn_automotriz.smn_series srie on
	rta.smn_serie_id = srie.sri_codigo
left outer join smn_automotriz.smn_planificacion_de_turno pdt on
...
where 
	...
	pdt.smn_areas_servicios_rf = ${fld:area_prestador}
