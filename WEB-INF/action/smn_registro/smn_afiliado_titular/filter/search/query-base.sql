...
select
	...
	(select smn_automotriz.smn_documento.doc_codigo|| ' - ' || smn_automotriz.smn_documento.doc_nombre from  smn_automotriz.smn_documento  where smn_automotriz.smn_documento.smn_documento_id is not null  and smn_automotriz.smn_documento.smn_documento_id=smn_automotriz.smn_afiliado_titular.smn_documento_id  order by smn_automotriz.smn_documento.doc_nombre ) as smn_documento_id_combo,
	(select smn_automotriz.smn_contratante.smn_documento_id || ' - ' || smn_automotriz.smn_contratante.cnt_numero_control from  smn_automotriz.smn_contratante  where smn_automotriz.smn_contratante.smn_contratante_id is not null  and smn_automotriz.smn_contratante.smn_contratante_id=smn_automotriz.smn_afiliado_titular.smn_contratante_id  order by smn_automotriz.smn_contratante.cnt_numero_control ) as smn_contratante_id_combo,
