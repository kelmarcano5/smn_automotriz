select
	...
	ps.smn_prestadores_servicios_id  as smn_prestadores_servicios_id
...
from
	...
	left join smn_base.smn_prestadores_servicios ps on ps.smn_prestadores_servicios_id = smn_automotriz.smn_diagnostico_cab_auto.smn_auxiliar_rf_prest
...
order by smn_automotriz.smn_diagnostico_cab_auto.dia_fecha_registro desc