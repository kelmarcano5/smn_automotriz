...
from
	...
	left outer join smn_base.smn_nivel_estructura on smn_base.smn_nivel_estructura.smn_nivel_estructura_id = smn_automotriz.smn_diagnostico_det_estruc_item.smn_nivel_estructura_rf
	left outer join smn_base.smn_servicios on smn_base.smn_servicios.smn_servicios_id = smn_automotriz.smn_diagnostico_det_estruc_item.smn_servicios_rf
...
where
	smn_automotriz.smn_diagnostico_det_auto.smn_diagnostico_cab_auto_id=${fld:id} ORDER BY smn_base.smn_servicios.svc_codigo, smn_base.smn_componentes.cmp_codigo asc
