...
where
	smn_automotriz.smn_diagnostico_cab_auto.smn_diagnostico_cab_auto_id is not null and smn_seguridad.s_user.userlogin='${def:user}' and smn_automotriz.smn_rol.rol_tipo='SO'
	${filter}
order by 
