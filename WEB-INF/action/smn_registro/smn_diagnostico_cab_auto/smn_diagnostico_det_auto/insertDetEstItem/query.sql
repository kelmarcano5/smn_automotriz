select smn_automotriz.smn_diagnostico_det_auto.smn_diagnostico_det_auto_id as id_det, 
	...
	case 
	 when smn_automotriz.smn_diagnostico_cab_auto.smn_auxiliar_rf_prest IS NULL then 0 else  smn_automotriz.smn_diagnostico_cab_auto.smn_auxiliar_rf_prest
	end as pres	
from smn_automotriz.smn_diagnostico_det_auto
	...
	inner join smn_base.smn_grupos_prestadores on smn_base.smn_grupos_prestadores.smn_grupos_prestadores_id = smn_base.smn_componentes.cmp_grupo_prestador
where smn_automotriz.smn_diagnostico_det_auto.smn_diagnostico_cab_auto_id=${fld:smn_diagnostico_cab_auto_id} 
and smn_automotriz.smn_diagnostico_det_auto.did_estatus='RE'