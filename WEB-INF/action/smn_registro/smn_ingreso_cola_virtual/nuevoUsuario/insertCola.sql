INSERT INTO smn_automotriz.smn_ingreso_cola_virtual
(
...
VALUES
(
	${seq:currval@smn_automotriz.seq_smn_ingreso_cola_virtual},
	 ${fld:entidad_prestador},
    ${fld:sucursal_prestador},
    ${fld:smn_area_servicio},
	${fld:smn_unidades_servicios_id},
	${fld:serie},
	(select sri_ultimo_numero+1 from smn_automotriz.smn_series where sri_codigo = ${fld:serie}),
	'${def:date}',
