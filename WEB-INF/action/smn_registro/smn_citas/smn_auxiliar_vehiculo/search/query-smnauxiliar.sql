...
from
	...
	where smn_base.smn_naturaleza_auxiliar.smn_naturaleza_auxiliar_id='3' and smn_base.smn_auxiliar.aux_tipo_persona='VA' ORDER BY smn_base.smn_auxiliar.smn_auxiliar_id desc