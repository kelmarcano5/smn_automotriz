select
	...
	smn_automotriz.smn_campos_visualizacion_monitores_dispositivos.smn_campos_vis_mon_dis_id as smn_campos_visualizacion_monitores_dispositivos_id
...
where
	...
	and 	smn_automotriz.smn_series.smn_series_id=smn_automotriz.smn_campos_visualizacion_monitores_dispositivos.smn_series_id
	${filter}
order by
