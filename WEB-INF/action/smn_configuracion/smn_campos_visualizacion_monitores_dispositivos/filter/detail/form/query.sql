select	
	...
	(select smn_automotriz.smn_dispositivos.dis_codigo || ' - ' || smn_automotriz.smn_dispositivos.dis_nombre from  smn_automotriz.smn_dispositivos  where smn_automotriz.smn_dispositivos.smn_dispositivos_id is not null  and smn_automotriz.smn_dispositivos.smn_dispositivos_id=smn_automotriz.smn_campos_visualizacion_monitores_dispositivos.smn_dispositivos_id  order by smn_automotriz.smn_dispositivos.dis_nombre ) as smn_dispositivos_id_combo,
