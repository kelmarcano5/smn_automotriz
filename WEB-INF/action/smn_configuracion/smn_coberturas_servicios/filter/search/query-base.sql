select	
	...
	smn_automotriz.smn_coberturas.cob_codigo as smn_coberturas_id_combo,
	...
	smn_automotriz.smn_coberturas_servicios.smn_coberturas_servicios_id
...
and 	smn_automotriz.smn_coberturas.smn_coberturas_id=smn_automotriz.smn_coberturas_servicios.smn_coberturas_id 
	 	${filter}
order by 
